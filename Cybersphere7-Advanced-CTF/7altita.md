...
![01-game-overview](screenshots/01-game-overview.png)

I noticed a platform at the top of the map, but it is clearly unreachable.

![02-game-overview](screenshots/02-game-overview.png)
...
![cheat-engine-process-list](screenshots/cheat-engine-process-list.png)
...
![final-scan](screenshots/final-scan.png)
...
![game-in-godot](screenshots/game-in-godot.png)
